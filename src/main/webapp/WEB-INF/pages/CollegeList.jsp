			...
			<table class="table table-striped table-bordered">
				<c:if test="${!empty list }">
					<tr>
						...
						<th class="col-md-1"><s:message code="label.state" /></th>
						<th class="col-md-1"><s:message code="label.city" /></th>
					...
					<c:forEach items="${list }" var="collegeList" varStatus="ct">
						<tr>
							...
							<td align="left"><c:out value="${collegeList.name }" /></td>
							<td align="left"><c:out value="${collegeList.address }" /></td>
							<td align="left"><c:out value="${collegeList.state }" /></td>
							<td align="left"><c:out value="${collegeList.city }" /></td>
							<td align="left"><c:out value="${collegeList.mobileNo }" /></td>
