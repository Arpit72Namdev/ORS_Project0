...
<link rel="stylesheet"
	href="/ORS_Project0/resources/css/bootstrap.min.css">

<script src="/ORS_Project0/resources/js/jquery.min.js"></script>
<script src="/ORS_Project0/resources/js/bootstrap.min.js"></script>
<script src="/ORS_Project0/resources/js/jquery-ui.js"></script>
<link rel="stylesheet"
	href="/ORS_Project0/resources/css/bootstrap-datepicker3.min.css">
<script src="/ORS_Project0/resources/js/bootstrap-datepicker.min.js"></script>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand"><img alt="Brand"
				...
				src="/ORS_Project0/resources/img/customsirLogo.png" width="150"
				height="30"></a>
		</div>
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="<c:url value="/SignUp" />"><span
							class="glyphicon glyphicon-list"></span> &nbsp;<s:message
								code="label.userRegistration" /></a></li>
			...
			<c:otherwise>
					...
					<c:if test="${sessionScope.user.roleId==1 }">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/User"/>"><s:message
											code="label.addUser" /></a></li>
								<li><a href="<c:url value="/ctl/User/search"/>"><s:message
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false"><s:message code="label.role" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/Role"/>"> <s:message
											code="label.addRole" />
								</a></li>
								<li><a href="<c:url value="/ctl/Role/search"/>"><s:message
											code="label.roleList" /> </a></li>
							</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false"><s:message code="label.student" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/Student"/>"><s:message
											code="label.addStudent" /></a></li>
								<li><a href="<c:url value="/ctl/Student/search"/>"><s:message
											code="label.studentList" /> </a></li>
							</ul></li>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false"><s:message code="label.college" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/College"/>"><s:message
											code="label.addCollege" /> </a></li>
								<li><a href="<c:url value="/ctl/College/search"/>"><s:message
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false"><s:message code="label.course" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/Course"/>"><s:message
											code="label.addCourse" /> </a></li>
								<li><a href="<c:url value="/ctl/Course/search"/>"><s:message
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false"><s:message code="label.faculty" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/Faculty"/>"><s:message
											code="label.addFaculty" /> </a></li>
								<li><a href="<c:url value="/ctl/Faculty/search"/>"><s:message
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							aria-expanded="false"><s:message code="label.marksheet" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/Marksheet"/>"><s:message
											code="label.addMarksheet" /> </a></li>
								<li><a href="<c:url value="/ctl/Marksheet/search"/>"><s:message
											code="label.marksheetList" /> </a></li>
								<li><a href="<c:url value="/ctl/Marksheet/get"/>"><s:message
											code="label.getMarksheet" /> </a></li>
								<li><a href="<c:url value="/ctl/Marksheet/meritlist"/>"><s:message
											code="label.meritList" /> </a></li>
							</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false"><s:message code="label.timetable" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/ctl/TimeTable"/>"><s:message
											code="label.addTimetable" /> </a></li>
								<li><a href="<c:url value="/ctl/TimeTable/search"/>"><s:message
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li style="color: white;"><a
						style="color: white; background-color: black;" href="#"><img
							alt="" src="/ORS_Project0/resources/img/checked-user-xxl.png"
							class="img-rounded" width="25" height="25"> <c:out
								value="${sessionScope.user.firstName} " />( <c:out
								value="${sessionScope.role.roleName} " />) </a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false"><s:message code="label.logout" /><span
							class="caret"></span></a>
						<ul class="dropdown-menu">

							<li><a href="<c:url value="/AboutUs/javadoc" />"
